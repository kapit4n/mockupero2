 ...
 */
angular.module("mockuperApp").service("projectService", [
  "$resource",
  "GlobalService",
  function ($resource, GlobalService) {
    ...
    fac.projects = $resource(
      GlobalService.BASE_PATH + "/projects",
      {},
      {
        get: {
          method: "GET",
    ...
    fac.projectById = $resource(
      GlobalService.BASE_PATH + "/projects/:projectId",
      {
        projectId: "@id",
      },
      {
    ...
    fac.deleteProject = $resource(
      GlobalService.BASE_PATH + "/projects/:id",
      {},
      {
        get: {
          method: "DELETE",
    ...
    fac.countProject = $resource(
      GlobalService.BASE_PATH + "/projectsCount",
      {},
      {
        get: {
          method: "GET",
    ...
    fac.shareProject = $resource(
      GlobalService.BASE_PATH + "/projectShare",
      {},
      {
        get: {
          method: "POST",
    ...
    fac.deleteProjectShare = $resource(
      GlobalService.BASE_PATH + "/projects/:id",
      {},
      {
        delete: {
    ...
    fac.reloadProject = function ($scope, $cookies) {
      fac.getProjectUsers
        .get({
          where: {
